...
Dynamic RGB UI: A "Super-smooth Low Opacity RGB" logo animation that cycles through colors for a modern look.

Frosted Glass Design: A premium, semi-transparent frosted glass layout with rounded corners and high-end blur effects.

Intuitive Navigation: Clean sidebar-based navigation system for easy access to Home, Effects, and Clicker modules.
...
Run AetherFlow Lite.exe.

Credits
Developed with a focus on blending automation logic with modern UI design principles.
